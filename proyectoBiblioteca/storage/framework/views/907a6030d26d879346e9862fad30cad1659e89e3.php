...
<div class="table-responsive container">
    ...
    <table class="table table-condensed table-hover table-bordered table-responsive">
      ...
      <tbody>
        <tr>
          ...
          <td><?php echo link_to_action('PrestamoLibroDocenteController@eliminarPrestamo', $title = 'Eliminar', $parameters = $prestamo->id, $attributes = ['class'=>'btn-danger btn-sm']); ?></td>
        </tr>
  ...
  <?php echo link_to_action('PrestamoLibroDocenteController@generarReporte', $title = 'Generar Reporte', $parameters = null, $attributes = ['class'=>'btn-success btn-lg']); ?>
